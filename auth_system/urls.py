...
urlpatterns = [
    ...
    path('<int:pk>/account/subscribers',views.SubscribersListView.as_view(),name='subscribers_list'),
    path('<int:pk>/account/subscribtions',views.SubscribtionsListView.as_view(),name='subscribtions_list'),
